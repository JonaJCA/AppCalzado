...
@section('title', 'Listado Usuarios - AppCalzado')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Listado Usuarios - AppCalzado</h4>
            </div>
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <p class="mb-0">¡Revisa el listado de los usuarios registrados en el sistema!</p>
                </div>
                <!-- Tabla de ejemplo -->
                <div class="card">
                    <div class="card-header">
